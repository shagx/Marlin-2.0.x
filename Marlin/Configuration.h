...
#define STRING_CONFIG_H_AUTHOR "(neil attempt, Ender-5-plus)" // Who made the changes.
...
#define INVERT_X_DIR true  //home to rear right is false
#define INVERT_Y_DIR true  //home to rear right is false
#define INVERT_Z_DIR true //makes bed go up on homing :)
